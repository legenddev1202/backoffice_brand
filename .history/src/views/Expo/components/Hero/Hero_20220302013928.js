  ...
  return (
    <section id="home">
      ...
      /> */}
        ...
        <div style={{ top: 200, right: 0, left:0, width:'100%', backgroundColor:'red', position:'absolute', paddingLeft:'150px', paddingRight:'150px' }}>
          <Grid container spacing={10}>
            <Grid item xs={12} md={9} style={{ position: 'relative', display: 'flex', alignItems:'flex-end', justifyContent:'center' }}>
